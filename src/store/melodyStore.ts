...
export const MELODY_PRESETS: MelodyPreset[] = [
  ...
  { name: "Acid Lead", params: mp({ waveform: "sawtooth", cutoff: 800, resonance: 20, envMod: 0.8, decay: 100, accent: 0.7, slideTime: 50, legato: false, distortion: 0.4, volume: 0.5, subOsc: 0 }) },
  { name: "Screamer", params: mp({ waveform: "sawtooth", cutoff: 600, resonance: 25, envMod: 0.9, decay: 80, accent: 0.8, slideTime: 30, legato: false, distortion: 0.6, volume: 0.45, subOsc: 0 }) },
  // ── Pluck / Staccato ──
  { name: "Bright Pluck", params: mp({ waveform: "square", cutoff: 3000, resonance: 10, envMod: 0.6, decay: 60, accent: 0.5, slideTime: 0, legato: false, distortion: 0.1, volume: 0.5, subOsc: 0 }) },
  { name: "Crystal Pluck", params: mp({ waveform: "triangle", cutoff: 4000, resonance: 6, envMod: 0.4, decay: 45, accent: 0.3, slideTime: 0, legato: false, distortion: 0, volume: 0.5, subOsc: 0 }) },
  { name: "Sharp Key", params: mp({ waveform: "square", cutoff: 2500, resonance: 14, envMod: 0.7, decay: 40, accent: 0.6, slideTime: 0, legato: false, distortion: 0.2, volume: 0.5, subOsc: 0 }) },
  { name: "Bell Tone", params: mp({ waveform: "triangle", cutoff: 3500, resonance: 12, envMod: 0.5, decay: 70, accent: 0.4, slideTime: 0, legato: false, distortion: 0, volume: 0.45, subOsc: 0.15 }) },
  // ── Legato / Smooth ──
  { name: "Smooth", params: mp({ waveform: "triangle", cutoff: 2500, resonance: 2, envMod: 0.1, decay: 300, accent: 0.15, slideTime: 100, legato: true, distortion: 0, volume: 0.45, subOsc: 0.3 }) },
  { name: "Warm Pad Lead", params: mp({ waveform: "triangle", cutoff: 1500, resonance: 3, envMod: 0.15, decay: 400, accent: 0.2, slideTime: 80, legato: true, distortion: 0, volume: 0.45, subOsc: 0.4 }) },
  { name: "Flute", params: mp({ waveform: "triangle", cutoff: 2000, resonance: 5, envMod: 0.2, decay: 350, accent: 0.25, slideTime: 60, legato: true, distortion: 0, volume: 0.45, subOsc: 0.1 }) },
  { name: "Soft Portamento", params: mp({ waveform: "sawtooth", cutoff: 1200, resonance: 4, envMod: 0.15, decay: 250, accent: 0.2, slideTime: 120, legato: true, distortion: 0.05, volume: 0.45, subOsc: 0.3 }) },
  // ── Arp / Sequence ──
  { name: "Retro Arp", params: mp({ waveform: "square", cutoff: 1800, resonance: 6, envMod: 0.5, decay: 120, accent: 0.3, slideTime: 20, legato: false, distortion: 0.2, volume: 0.5, subOsc: 0.2 }) },
  { name: "Trance Arp", params: mp({ waveform: "sawtooth", cutoff: 1400, resonance: 10, envMod: 0.55, decay: 90, accent: 0.45, slideTime: 10, legato: false, distortion: 0.15, volume: 0.5, subOsc: 0.15 }) },
  { name: "Chip Arp", params: mp({ waveform: "square", cutoff: 5000, resonance: 2, envMod: 0.3, decay: 50, accent: 0.3, slideTime: 0, legato: false, distortion: 0.1, volume: 0.5, subOsc: 0 }) },
  // ── Dirty / Aggressive ──
  { name: "Distorted Saw", params: mp({ waveform: "sawtooth", cutoff: 1000, resonance: 8, envMod: 0.45, decay: 130, accent: 0.65, slideTime: 15, legato: false, distortion: 0.7, volume: 0.45, subOsc: 0 }) },
  { name: "Gritty Square", params: mp({ waveform: "square", cutoff: 700, resonance: 16, envMod: 0.6, decay: 100, accent: 0.7, slideTime: 25, legato: false, distortion: 0.5, volume: 0.5, subOsc: 0.1 }) },
  { name: "Noise Lead", params: mp({ waveform: "sawtooth", cutoff: 500, resonance: 22, envMod: 0.85, decay: 70, accent: 0.85, slideTime: 35, legato: false, distortion: 0.8, volume: 0.4, subOsc: 0 }) },
  // ── Lo-Fi / Muted ──
  { name: "Muted", params: mp({ waveform: "square", cutoff: 400, resonance: 4, envMod: 0.2, decay: 200, accent: 0.3, slideTime: 60, legato: false, distortion: 0.05, volume: 0.5, subOsc: 0.5 }) },
  { name: "Vinyl Keys", params: mp({ waveform: "triangle", cutoff: 600, resonance: 6, envMod: 0.25, decay: 180, accent: 0.3, slideTime: 40, legato: false, distortion: 0.15, volume: 0.45, subOsc: 0.35 }) },
  { name: "Tape Wobble", params: mp({ waveform: "sawtooth", cutoff: 550, resonance: 7, envMod: 0.3, decay: 220, accent: 0.35, slideTime: 70, legato: true, distortion: 0.2, volume: 0.45, subOsc: 0.4 }) },
  // ── Ambient / Atmospheric ──
  { name: "Atmosphere", params: mp({ waveform: "triangle", cutoff: 800, resonance: 3, envMod: 0.08, decay: 500, accent: 0.1, slideTime: 150, legato: true, distortion: 0, volume: 0.4, subOsc: 0.6 }) },
  { name: "Space Echo", params: mp({ waveform: "sawtooth", cutoff: 1000, resonance: 5, envMod: 0.12, decay: 400, accent: 0.2, slideTime: 90, legato: true, distortion: 0.05, volume: 0.4, subOsc: 0.25 }) },
];
