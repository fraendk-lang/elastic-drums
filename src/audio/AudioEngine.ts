...
export class AudioEngine {
  ...
  private getContext(): AudioContext {
    if (!this.ctx) {
      ...
      // 0-5 drums, 6-9 hats, 10-11 perc, 12 bass, 13 chords, 14 melody, 15 sampler, 16-23 loops (LP 1–8), 24-26 melody layers (LAY 1–3)
      const groups = ["drums", "drums", "drums", "drums", "drums", "drums", "hats", "hats", "hats", "hats", "perc", "perc", "bass", "chords", "melody", "sampler", "loops", "loops", "loops", "loops", "loops", "loops", "loops", "loops", "melody", "melody", "melody"];
